...
<div class="bg-gray-300 dark:bg-gray-700 py-10 sm:px-5">
    <h2 class="text-2xl md:text-4xl text-gray-800 dark:text-gray-100 text-center font-extrabold my-5">Buscar y Filtrar Vacantes</h2>

    <div class="max-w-5xl mx-5 md:mx-auto ">
        <form wire:submit.prevent='leerDatosForm'>
            <div class="md:grid md:grid-cols-3 gap-5">
                <div class="mb-5">
                    <label 
                        class="block mb-1 text-sm text-gray-700 dark:text-white uppercase font-bold "
            ...
            <div class="flex justify-end">
                <input 
                    type="submit"
                    class="bg-indigo-700 hover:bg-indigo-800 transition-colors text-white text-sm font-bold px-10 py-2 rounded cursor-pointer uppercase w-full md:w-auto"
                    value="Buscar"
                />
            </div>
        </form>
