    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                @auth
                    @can('create', App\Models\Vacante::class)
                        <a class="mr-2 w-7 h-7 bg-indigo-600 hover:bg-indigo-700 rounded-full flex flex-col justify-center items-center text-sm font-extrabold text-white" href="{{ route('notificaciones') }}">
            ...
            <div class="pt-2 pb-3 space-y-1">
                ...
                <a href="{{ route('notificaciones') }}">
                    <div class="flex gap-2 items-center p-3">
                        <p class="w-7 h-7 bg-indigo-600 hover:bg-indigo-700 rounded-full flex flex-col justify-center items-center text-sm font-extrabold text-white">
                            {{Auth::user()->unreadNotifications->count()}}
                        </p>
